...
test("extractSnippets handles #remove and #uncomment", () => {
  ...
  assert.ok(
    !lines.includes('console.log("hidden block");'),
    "Hidden block line should be removed"
  );
  assert.ok(
    !lines.includes('console.log("hidden single");'),
    "Hidden single line should be removed"
  );
  assert.ok(
    lines.includes('console.log("visible");'),
    "Visible line should be present"
  );
  assert.ok(
    lines.includes('console.log("uncommented block");'),
    "Uncommented block line should be present"
  );
  assert.ok(
    lines.includes('console.log("uncommented single");'),
    "Uncommented single line should be present"
  );
});
